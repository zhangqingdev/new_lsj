package com.oushangfeng.lsj.http;
...
public class Api {
     //老司机客户端api接口
      ...
      //微信登录接口
      public static final String GET_WEIXIN_LOGIN="insider/weixin/login";
      //获取文章
      public static final String GET_INDEX_ARTICLE="insider/app/article";
      //更新tokenS
      public static final String GET_UPDATA_TOKEN="insider/app/token/flush/";
